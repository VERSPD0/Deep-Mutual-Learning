...
IMAGE_DIR=/home/dingyf/lwy/Deep-Mutual-Learning-master/data/Market-1501/Market-1501-v15.09.15


# Where the TFRecord data will be saved to.
TF_DIR=/home/dingyf/lwy/Deep-Mutual-Learning-master/data/image
...
# bounding_box_test
# for split in bounding_box_train ; do
