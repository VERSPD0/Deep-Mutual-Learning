...
_SPLITS_NAMES = ['bounding_box_train', 'bounding_box_test', 'gt_bbox', 'query', 'train', 'test']
...
def get_split(split_name, dataset_dir, file_pattern=None, reader=None):
    ...
    num_examples = 50000 if split_name == 'train' else 10000
    ...
    return slim.dataset.Dataset(
        ...
        reader=reader,
        decoder=decoder,
        num_samples=num_examples,   # over all data size
